...
<body>
    <main class="flex min-h-96 flex-col justify-center items-center">
        ...
        <p class="text-zinc-600 text-center">One stop Hub for generating <br>side income through a wide range of
            activities</p>
    ...
    <div class="flex justify-center items-center min-h-48 pb-24">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-24 max-w-4xl">
            ...
            <a href="{{ route('marketplace.marketindex') }}" class="hover:bg-gray-100 p-3 rounded-sm">
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <p class="text-xl text-primary font-semibold mb-1">
                            Marketplace
                        </p>
                        <p class="text-gray-600 text-sm text-justify">
                            Your one-stop shop for everything you need. Discover a wide range of products and services
                            from
            ...
            <!-- Parcel Pickup -->
            <a href="{{ route('parcel.service') }}" class="hover:bg-gray-100 p-3 rounded-sm">
                <div class="flex items-start space-x-4">
                    <div class="bg-redIconColor p-3 rounded-lg">
                        <i class="text-white">
            ...
            <div class="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm text-justify">
                        Let us handle your laundry while you focus on what matters. We'll pick up your dirty clothes,
                        wash,
