...
<body class="bg-tertiary text-gray-900">
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            <h1 class="text-2xl font-bold mb-2">Welcome to Student Grab!</h1>
            <p class="text-gray-600">Reliable and affordable transportation for students.
                We provide safe and comfortable rides to and from school, extracurricular activities, and more.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold">Create Grab Request</h2>
                ...
                <p class="text-gray-600 mb-4">Schedule a new pickup quickly and conveniently.</p>
            ...
            <!-- Track Pickup Request Card -->
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold">Track Pickup Request</h2>
                ...
                <p class="text-gray-600 mb-4">Track the status of your ongoing pickup requests.</p>
                <a href="{{ route('studentgrab.index') }}"
            ...
            <!-- My Pickup Requests Card -->
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold">My Pickup Requests</h2>
                ...
                <p class="text-gray-600 mb-4">View and manage all your personal pickup requests.</p>
                <a href="{{ route('studentgrab.myStudentGrab') }}"
