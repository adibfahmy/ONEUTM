        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg border border-gray-300">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-2xl font-bold mb-4">Create Student Grab Pickup Request</h2>
                    ...
                    <form action="{{ route('studentgrab.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <button type="submit"
                                ...
                                Create Student Grab Pickup Request
                            </button>
                        </div>
                    </form>
                </div>
