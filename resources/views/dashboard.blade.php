...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
        ...
        <nav class="flex justify-between flex-row p-3  border-b border-gray-300 shadow-sm ">
            ...
            <div class="flex items-center">
                ...
                <div class="text-zinc-500 space-x-4">
                  ...
                  <a href="{{ route('admin.dashboard') }}" class="hover:text-primary">More</a>
    ...
    <div class="py-12">
        ...
        <main class="flex min-h-96 flex-col justify-center items-center">
                ...
                <p class="text-zinc-600 text-center">One stop Hub for generating <br>side income through a wide range of activities</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-24 max-w-4xl">
              ...
              <div class="flex items-start space-x-4">
                <div class="bg-redIconColor p-3 rounded-lg">
                  <i class="text-white"><svg  xmlns="http://www.w3.org/2000/svg"  width="32"  height="32"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-bag"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6.331 8h11.339a2 2 0 0 1 1.977 2.304l-1.255 8.152a3 3 0 0 1 -2.966 2.544h-6.852a3 3 0 0 1 -2.965 -2.544l-1.255 -8.152a2 2 0 0 1 1.977 -2.304z" /><path d="M9 11v-5a3 3 0 0 1 6 0v5" /></svg></i>
                </div>
                <div>
                  ...
                  <p class="text-gray-600 text-sm text-justify">
                    Your one-stop shop for everything you need. Discover a wide range of products and services from trusted sellers, all in one convenient place.
                  </p>
                </div>
              </div>
...
<div class="flex items-start space-x-4">
    <a href="{{ route('parcel.service') }}" class="flex items-start space-x-4">
        <div class="bg-redIconColor p-3 rounded-lg">
            <i class="text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-packages">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div>
            ...
            <p class="text-gray-600 text-sm text-justify">
                Conveniently pick up your packages at your preferred location. No more missed deliveries or long wait times.
            </p>
        </div>
    </a>
</div>
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600 text-sm text-justify">
                    Reliable and affordable transportation for students. We provide safe and comfortable rides to and from school, extracurricular activities, and more.
                  </p>
                </div>
              </div>
            </div>
